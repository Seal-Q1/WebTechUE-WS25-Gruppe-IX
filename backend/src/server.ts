...
import {adminRouter, authRouter, bankingRouter, cuisinesRouter, loyaltyRouter, menuItemsRouter, orderPlacementRouter, ordersRouter, restaurantsRouter, usersRouter} from './routes';
